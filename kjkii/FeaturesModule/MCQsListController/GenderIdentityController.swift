...
class GenderIdentityController: UIViewController {
    
    
    @IBOutlet weak var lblQuestion: APLabel!
    @IBOutlet weak var tableView:UITableView!

    var mData:[String] = AppData.GENDER_IDENTITY
    var selected:Int = -1
...
extension GenderIdentityController: UITableViewDelegate, UITableViewDataSource {
